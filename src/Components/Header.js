        ...
        <div className="max-w-xl sm:mx-auto lg:max-w-2xl">
          <div className="flex flex-col mb-16 sm:text-center sm:mb-0">
            ...
            <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
              ...
              Halo makhluk bumi! Kenalin aku salah satu bagian dari kalian. Pasti kalian udah sering ketemu makhluk - makhluk bumi lain selain aku. 
              Tapi yang satu ini beda nih. Bedanya apa sih?
              </p>
            </div>
            <div>
              <a
